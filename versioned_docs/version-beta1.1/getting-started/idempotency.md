...
Idempotency ensures that you can safely retry API requests without unintended side effects. This is crucial for payment operations.
...
- Extended idempotency key validity period (48 hours)
